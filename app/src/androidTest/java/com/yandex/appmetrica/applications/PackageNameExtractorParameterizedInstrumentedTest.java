...
public class PackageNameExtractorParameterizedInstrumentedTest {
    ...
    public PackageNameExtractorParameterizedInstrumentedTest(List<PackageInfo> input, List<String> output) {
        mInput = input;
        mOutput = output;
    }
